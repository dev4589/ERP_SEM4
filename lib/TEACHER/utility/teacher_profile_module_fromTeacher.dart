...
class TeacherProfileFormForTeach extends StatefulWidget {
  String emp_no;
  TeacherProfileFormForTeach(this.emp_no);
  @override
  _TeacherProfileFormForTeachState createState() => _TeacherProfileFormForTeachState();
}

class _TeacherProfileFormForTeachState extends State<TeacherProfileFormForTeach> {
  ...
  Widget build(BuildContext context) {
    ...
    String name=dataMap['name']+" "+dataMap['fathername']+" "+dataMap['surname'];
    String caddress=dataMap['address'];
    String email=dataMap['email'];
    String gender=dataMap['gender'];
    String designation=dataMap['source'];
    String dateofjoin=dataMap['join_date'];
    String contactno=dataMap['cno1'];
    String dob=dataMap['dob'];
    String pincode=dataMap['pincode'];
    String formno=dataMap['form_no'];
    String fname=dataMap['fathername'];
    String mname=dataMap['mothername'];
    String altnumber=dataMap['cno2'];
    String joinyear=dataMap['joinyear'];
    String lastjob=dataMap['lastjob'];
    String reference=dataMap['reference'];
