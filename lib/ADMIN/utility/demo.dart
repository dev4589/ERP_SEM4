...
class demoR extends StatefulWidget {
  @override
  _demoR createState() => _demoR();
}

class _demoR extends State<demoR> {
  ...
  fireauth() async {
    final querySnapshot = await FirebaseFirestore.instance
        ...
        .where('class', isEqualTo: classStr)
        .where('division', isEqualTo: sectionS)
        .get();
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> addattendance() {
      ...
      return attendance.add({
        ...
        'student': [
          for (int i = 0; i < mapList[0]['students'].length; i++)
            {
              'grNo': mapList[0]['students'][i]['grNo'],
              'student': mapList[0]['students'][i]['name'],
                                ...
                                child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            "Student Attendance | Class : $classStr , Section : $sectionS , Date : " +
                                                academicdate.text,
                                            style: gridviewtext),
                                        SizedBox(height: 20),
                                        Wrap(
